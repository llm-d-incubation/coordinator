...
// sharedStorageEC is the EC connector for the shared_storage topology. Encoder
...
func (sharedStorageEC) PreparePrefillECParams(_ *pipeline.RequestContext) map[string]any {
	return nil
}
