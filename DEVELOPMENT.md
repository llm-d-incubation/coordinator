...
| `VLLM_IMAGE` | `ghcr.io/llm-d/llm-d-inference-sim:v0.9.1` | vLLM simulator image |
| `VLLM_RENDER_IMAGE` | `ghcr.io/llm-d/llm-d-inference-sim:v0.9.1` | Render sidecar image |
